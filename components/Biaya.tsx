...
const biayaBulanan = [
  { label: "Biaya Pondok & Makan", amount: "Rp 450.000" },
  { label: "Kamar & Diniyah", amount: "Rp 100.000" },
  { label: "Tabungan Khataman & Ziarah", amount: "Rp 50.000" },
];

const biayaPertamaKali = [
  { label: "Kitab Ma'ani (3 Jilid) + Nahwu (2 Jilid)", amount: "Rp 100.000" },
  { label: "Infaq Santri Baru", amount: "Rp 500.000" },
];
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-extrabold text-gray-800">
            Rincian Biaya Pondok
          </h2>
          <p className="text-gray-500 mt-2 text-sm max-w-xl mx-auto">
            Biaya yang terjangkau dengan fasilitas dan program pendidikan
            berkualitas tinggi.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-green-700 rounded-3xl p-8 text-white">
            ...
            <div className="bg-white/10 rounded-2xl p-4 flex justify-between items-center">
              ...
              <span className="text-2xl font-extrabold text-yellow-300">Rp 600.000</span>
            </div>
          </div>
          ...
          <div className="bg-green-50 rounded-3xl p-8">
            ...
            <div className="bg-green-100 rounded-2xl p-4 flex justify-between items-center">
              ...
              <span className="text-2xl font-extrabold text-green-700">Rp 600.000</span>
            </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-4 flex gap-3">
          ...
          <p className="text-sm text-yellow-800">
            <strong>Catatan:</strong> Biaya dapat berubah sewaktu-waktu. Untuk informasi terkini,
            silakan hubungi pengurus pondok secara langsung.
          </p>
        </div>
      </div>
    </section>
